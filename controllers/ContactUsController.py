...
def create(Session, ContactUs, request):
    ...
    last_insert_id = contact_us_model.create(Session, ContactUs, request);
    base64Json = contact_us_model.get_token(Session, ContactUs, last_insert_id)
    json = {
        "success": True,
...
def mail(Session, ContactUs, base64_json):
    contact_us_model = ContactUsModel
    contact_us_model = contact_us_model.apply_from_token(Session, ContactUs, base64_json);
